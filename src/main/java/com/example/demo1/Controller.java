...
public class Controller {
    ...
    public void initialize() {
        save.setOnAction(clik -> {
            try {
                String line = ("Препарат: "+" "+nameInput.getText()+" ");
                String line2=("Дата производства: "+ageInput.getText()+" ");
                String line3=("Количество препарата: "+numberInput.getText()+" ");
                FileOutputStream fileOutputStream =new FileOutputStream("C:\\Users\\User\\IdeaProjects\\demo1\\src\\main\\resources\\com\\example\\demo1\\data.txt");
